// Визначити інтерфейс ISalary з методом для нарахування місячного доходу і методом для форматного виведення інформації
// про об’єкт на екран. Класи Student (з полями: ім’я і середній бал) і Teacher (з полями: ім’я і посада) повинні
// реалізовувати цей інтерфейс. Дохід студента визначається наявністю стипендії, якщо його середній бал є більшим за
// 4,5. Дохід викладача залежить від посади (задати різні оклади для асистента, доцента і професора). Обидва класи мають 
// наслідувати інтерфейс IComparable. Утворити змішаний масив з викладачів і студентів. Вивести на екран. Посортувати
// його за розміром доходу в порядку зростання. Вивести викладачів з доходом, більшим за 10000.
